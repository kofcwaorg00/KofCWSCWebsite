...
namespace KofCWSCWebsite.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        public AspNetUsersController(ApiHelper apiHelper)
        {
        ...
        public async Task<IActionResult> NewMemberApproval(string id)
        {
            return View();
        }
        public async Task<IActionResult> RejectNewMember(string id)
        {
            return View();
        }
